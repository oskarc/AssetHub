...
info()  { echo -e "${GREEN}[backup]${NC} $*"; return 0; }
warn()  { echo -e "${YELLOW}[backup]${NC} $*"; return 0; }
die()   { echo -e "${RED}[backup]${NC} $*" >&2; exit 1; } # NOSONAR — exit always terminates; explicit return would be unreachable
